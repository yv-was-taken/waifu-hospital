...
class ImageService {
  ...
  createImagePrompt({ description, personality, style }) {
    ...
    const styleGuides = {
      anime: 'Japanese anime art style with clean lines, vibrant colors, and large expressive eyes. Semi-realistic proportions, detailed hair with dynamic shading, soft cel-shading technique. High contrast lighting with subtle ambient occlusion.',
      retro: '80s-90s classic anime style girl with bold outlines and vintage color palette. Sailor uniform or retro fashion, big sparkly eyes, and detailed hand-drawn style shading. Hair styled in classic anime fashion with vintage shoujo manga aesthetics. Reminiscent of Studio Ghibli or 90s magical girl anime.',
      gothic: 'Gothic lolita anime girl with Victorian-inspired black and dark purple dress, frilly accessories, and elegant ribbons. Long flowing dark hair with drill curls or straight style. Pale skin, melancholic expression, holding parasol or roses. Dark atmospheric background with gothic architecture elements.',
      neocyber: 'Cyberpunk anime girl with neon-colored hair highlights and futuristic fashion. Holographic accessories, cyber implants, and glowing tech patterns on clothing. Modern urban night background with neon signs. Reminiscent of Ghost in the Shell or Cyberpunk Edgerunners style.',
      fantasy: 'Magical anime girl with flowing ethereal dress and mystical accessories. Long flowing hair with magical particles and sparkles. Detailed fantasy outfit with ribbons and ornate decorations. Wielding staff or magical elements, with fairy-like or elvish features. Soft dreamy background with magical elements.',
      'sci-fi': 'Futuristic anime girl in sleek pilot suit or high-tech armor. Clean, minimalist sci-fi uniform with glowing accents. Short practical or long flowing hair with tech accessories. Holographic displays and mechanical elements in background. Similar to Evangelion or Knights of Sidonia aesthetic.',
      chibi: 'Ultra-cute chibi anime girl with exaggerated kawaii features. Extra large head and eyes taking up half of face, tiny body. Oversized clothing with cute accessories and pastel colors. Simple moe art style with rounded elements and cheerful expression. Bubbly, cute background elements.'
    };
