...
// @access  Private
router.get('/creator', authMiddleware, merchandiseController.getCreatorMerchandise);

// @route   GET /api/merchandise/character/:characterId
// @desc    Get all merchandise for a character
// @access  Public
router.get('/character/:characterId', merchandiseController.getCharacterMerchandise);
